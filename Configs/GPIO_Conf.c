...
const GPIO_PIN_MODE_t GPIO_pinStatusArray[PIN_TOTAL] = {
	{.MODER=MODER_INPUT,.OSPEEDER=OSPEEDER_LOW_SPEED,.OTYPER=OTYPER_OUTPUT_OPEN_DRAIN,.PUPDR=PUPDR_PULL_UP}, /*     PINA0     */
	...
	{.MODER=MODER_OUTPUT,.OSPEEDER=OSPEEDER_LOW_SPEED,.OTYPER=OTYPER_OUTPUT_PUSH_PULL,.PUPDR=PUPDR_NO_PULL_UP_PULL_DOWN}, /*     PINA13  USED FOR DEBUGGING  */
	{.MODER=MODER_OUTPUT,.OSPEEDER=OSPEEDER_LOW_SPEED,.OTYPER=OTYPER_OUTPUT_PUSH_PULL,.PUPDR=PUPDR_NO_PULL_UP_PULL_DOWN}, /*     PINA14  USED FOR DEBUGGING  */
	{.MODER=MODER_OUTPUT,.OSPEEDER=OSPEEDER_LOW_SPEED,.OTYPER=OTYPER_OUTPUT_PUSH_PULL,.PUPDR=PUPDR_NO_PULL_UP_PULL_DOWN}, /*     PINA15  USED FOR DEBUGGING  */
	...
	{.MODER=MODER_OUTPUT,.OSPEEDER=OSPEEDER_LOW_SPEED,.OTYPER=OTYPER_OUTPUT_PUSH_PULL,.PUPDR=PUPDR_NO_PULL_UP_PULL_DOWN}, /*     PINB3   USED FOR DEBUGGING  */
	{.MODER=MODER_OUTPUT,.OSPEEDER=OSPEEDER_LOW_SPEED,.OTYPER=OTYPER_OUTPUT_PUSH_PULL,.PUPDR=PUPDR_NO_PULL_UP_PULL_DOWN}, /*     PINB4   USED FOR DEBUGGING  */
